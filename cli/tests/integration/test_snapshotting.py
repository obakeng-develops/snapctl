...
class TestCreateClusterSnapshot:
    ...
    def test_snapshot_id_includes_timestamp(self, mock_aws_credentials, mock_rds_cluster):
        ...
        assert result1["DBClusterSnapshotIdentifier"] != result2["DBClusterSnapshotIdentifier"]
