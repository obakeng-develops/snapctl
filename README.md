...
When using AWS Organisations, `snapctl` will setup the required key policies, create the necessary IAM roles and IAM policies and then commence backup of an instance in and cross-account. You can also scan resources to verofy dependencies.
